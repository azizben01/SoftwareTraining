            ...
            >
              {[...PROJECT_IMAGES, ...PROJECT_IMAGES, ...PROJECT_IMAGES].map((img, index) => (
                <div
                  ...
                  className="relative flex-shrink-0 w-[460px] h-[260px] lg:h-[350px] rounded-2xl shadow-4xl overflow-hidden hover:brightness-90 transition-all duration-300 mr-6"
                >
                  <Image
                    src={img.src}
                    alt={img.alt}
